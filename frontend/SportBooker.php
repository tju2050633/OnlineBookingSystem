<html>
    ...
    <body>
        ...
        <?php
            ...
            $separator = " "; 
            $Times = implode($separator, $selectedTimes);
            echo '<br>';
            echo "Pay: " . $Pay;
            '<br><br>';
            ...
            $outputstring = $today."\t Name: ". $Name. "\t Phone: " . $Phone . "\t Center: " . $Center  ."\t Venues: ".$V ."\t Date: " . $Date . "\t Times: " . $Times . "\t Pay: " . $Pay ."\n";
            @ $fp = fopen("../frontend/booking.txt", 'ab');
            if (!$fp){
